...
function activate(context) {
    context.subscriptions.push(vscode_1.commands.registerCommand("rmarkdown_vscode.editing.toggleBold", toggleBold), vscode_1.commands.registerCommand("rmarkdown_vscode.editing.toggleItalic", toggleItalic), vscode_1.commands.registerCommand("rmarkdown_vscode.editing.toggleStrikethrough", toggleStrikethrough), vscode_1.commands.registerCommand("rmarkdown_vscode.editing.toggleHeadingUp", toggleHeadingUp), vscode_1.commands.registerCommand("rmarkdown_vscode.editing.toggleHeadingDown", toggleHeadingDown), vscode_1.commands.registerCommand("rmarkdown_vscode.editing.toggleList", toggleList), vscode_1.commands.registerCommand("rmarkdown_vscode.editing.paste", paste));
}
