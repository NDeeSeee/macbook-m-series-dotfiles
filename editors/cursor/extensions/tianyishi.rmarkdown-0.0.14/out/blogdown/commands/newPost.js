...
class NewPost extends BaseCommand_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.TotalSteps = 4;
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const state = { projectDir: vscode.workspace.workspaceFolders[0].uri.path, author: defaultAuthor };
            if (!(yield common_1.MultiStepInput.run((input) => this.setTitle(input, state)))) {
                // command cancelled
                return;
            }
