...
function activate(_) {
    ...
    if (!vscode_1.workspace.getConfiguration("rmarkdown.syntax").get("decorations"))
        return;
...
function updateDecorations(editor) {
    ...
    // e.g. { "(~~.+?~~)": ["strikethrough"] }
    let appliedMappings = vscode_1.workspace.getConfiguration("rmarkdown.syntax").get("plainTheme") ? Object.assign(Object.assign({}, regexDecorTypeMappingPlainTheme), regexDecorTypeMapping) : regexDecorTypeMapping;
    doc
        .getText()
        .split(/\r?\n/g)
