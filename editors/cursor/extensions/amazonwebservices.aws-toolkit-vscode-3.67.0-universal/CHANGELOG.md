...
- **Bug Fix** System Path parsing should ignore Windows and only parse Mac/Linux system, Sam Local Invoke should get correct system Path on windows [#5933](https://github.com/aws/aws-toolkit-vscode/issues/5933) [#5918](https://github.com/aws/aws-toolkit-vscode/issues/5918)
